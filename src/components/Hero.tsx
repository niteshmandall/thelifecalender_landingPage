    ...
    >
      ...
      >
        <div className="animate-fade-in">
          ...
          >
            A minimalist live wallpaper that helps you stay mindful of your
            time. Track your life, year, or goals directly on your home screen.
          </p>
          ...
          >
            <a href="/app-release.apk" download className="btn-primary">
              Download APK
            </a>
          ...
          {Array.from({ length: 480 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: "50%",
                background:
                  i < 150 ? "var(--text-primary)" : "var(--text-secondary)",
